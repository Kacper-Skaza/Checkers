...
struct Button
{
	...
	bool selected;	// Wybrana opcja (ustawienia)
};
...
// Tablica reprezentuj¹ca planszê
// -2 -> damka (czerwona)
...
// Tablice przechowuj¹ce przyciski
extern vector<Button> g_GameButtons;
extern vector<Button> g_MenuButtons;
extern vector<Button> g_SettingsButtons;
extern vector<Button> g_CreditsButtons;

// Tablica reprezentuj¹ca g³ówne pole tekstowe
